      ...
      <main className="flex-1 p-7 overflow-y-auto">
        ...
        <div className="flex gap-5">
          ...
          <div className="w-64 flex-shrink-0 bg-white/4 border border-white/8 rounded-xl p-6 flex flex-col items-center text-center">
            ...
            {/* Level */}
            <div className={`w-full mt-5 rounded-xl p-4 border ${
              profile.level === 'GOLD'   ? 'bg-yellow-500/8 border-yellow-500/20' :
              ...
              <div className={`text-xl font-bold ${
                profile.level === 'GOLD' ? 'text-yellow-400' :
                      ...
                      <div key={i} className="flex flex-col items-center gap-1 flex-1">
                        ...
                        <div
                          className={`w-full rounded-t min-h-1 ${
                            sc.value >= 8 ? 'bg-green-400' : sc.value >= 5 ? 'bg-amber-400' : 'bg-red-400'
                          }`}
                ...
                {milestones.map(m => (
                  <div key={m.tasks} className="text-center">
                    <div className={`w-2.5 h-2.5 rounded-full mx-auto mb-1 ${
                      profile.onTimeCount >= m.tasks ? 'bg-yellow-400' : 'bg-white/15 border border-white/25'
                    }`} />
                ...
                : scores.slice(0, 6).map((sc, i) => (
                  <div key={i} className="flex items-center gap-3 py-2.5 border-b border-white/8 last:border-0">
                    ...
                    <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${
                      sc.value >= 8 ? 'bg-green-500/15 text-green-400' :
